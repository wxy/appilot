...
const input = {
  ...
  platform: "ios",
  relatedPlatforms: ["macos", "ios", "macos"],
...
assert(profile.relatedPlatforms.join(",") === "macos", "profile: related platforms are normalized and exclude the target");
...
assert(block.includes("Related platforms: macos"), "prompt block: related platforms");
