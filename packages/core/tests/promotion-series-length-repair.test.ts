...
import { xPostWeightedLength, type ProductPromotionProfile, type PromotionSourceSnapshot, type XPromotionSeriesItem } from "../src/promotion";
...
async function main() {
  ...
  assert.equal(repairedMissingLink.imagePrompt, undefined, "post repair does not create image work");
