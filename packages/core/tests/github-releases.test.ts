...
import { listGitHubReleases } from "../src/github-api";
import { fetchStoreCurrentVersion } from "../src/app-store-discovery";
...
async function runTests() {
  ...
  try {
    ...
    const { fetchStoreLocalizedCopy } = await import("../src/app-store-discovery");
