...
/**
 * Stable draft id. Version-level App Store copy and screenshots belong to a
 * concrete store product/platform. App-level name/subtitle may be shared by
 * Apple, but must not collapse the rest of the release draft across platforms.
 */
