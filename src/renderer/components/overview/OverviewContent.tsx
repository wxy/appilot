...
import { MetricBlock, overviewRankRows } from "./overviewData";
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
        ...
        />
        <MetricBlock LinkComponent={LinkComponent} to="/keywords?scope=top10" label="前 10" value={String(top10Count)} highlight={top10Count > 0} />
        <MetricBlock
          LinkComponent={LinkComponent}
          to="/keywords"
          label="最近采集"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
        ...
        <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden shadow-sm">
          <div className="px-5 py-3 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50 flex items-center justify-between">
            ...
            <LinkComponent to="/keywords" className="text-[11px] text-amber-600 dark:text-amber-400 hover:underline">
              查看全部 →
            </LinkComponent>
          </div>
          {rankRows.length === 0 ? (
