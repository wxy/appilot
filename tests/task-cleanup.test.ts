...
const tasks = [
  ...
  { id: "o1", kind: "ops-sync", projectId: "proj-1" },
  { id: "o2", kind: "ops-sync", projectId: "proj-2" },
];
...
async function runTests() {
  ...
  assert(!kept.some((t) => t.id === "o1"), "ops-sync task of removed project is removed");
  assert(kept.some((t) => t.id === "o2"), "ops-sync task of other project is kept");
