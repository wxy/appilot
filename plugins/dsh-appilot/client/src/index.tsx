...
import { AppilotWorkbench, REFRESH_PROMPT, BRIEF_PROMPT, TASKS_PROMPT, taskRunPrompt } from './workbench';
    ...
    ctx.slots.register(
      {
        ...
        inject: (sessionId: string) => {
          ...
          return {
            ...
            runTask: (taskId: string) => sendToDedicated(ctx, cwdOf(), taskRunPrompt(taskId)),
