 ...
 *  2. conversation.session.header.utilities — AI 计量小卡（非 Appilot GUI）。
 *
 * 服务端：agent 工具集（appilot_tasks / appilot_task_run / appilot_snapshots /
 * appilot_overview + dsh-project 的 list/register）+ **斜杠命令 /appilot
 * （task 状态 / clear / reschedule，直读共享 DB，不经模型）**——任何会话可用；
 * 深链路 GUI 在 Electron。
 *
